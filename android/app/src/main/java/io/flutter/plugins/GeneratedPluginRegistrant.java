...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.camerakit.camerakit_flutter.CamerakitFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin camerakit_flutter, com.camerakit.camerakit_flutter.CamerakitFlutterPlugin", e);
    }
    try {
